...
const trainDataUrl = "file://./tensorflow-moons/train/_annotations.csv";
const testDataUrl = "file://./tensorflow-moons/test/_annotations.csv";
...
const loadData = function (dataUrl, batches = batchSize) {
  ...
  return tf.data
    .csv(dataUrl, { columnConfigs: { class: { isLabel: true } } })
    .map(normalize)
...
const run = async function () {
  ...
  const saveModelPath = "file://./moon-phases";
